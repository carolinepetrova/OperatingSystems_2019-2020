...
5. `find` - командата без аргументи извежда на екрана абсолютно всички файлове (дори и тези в поддиректориите) на текущата директория, в която се намирате
	
		Синтаксис: `find [dir-to-be-searched] [arguments]` 

		- Търсене по име на файл 
		
			`find / -name d*` - търси в цялата файлова система файлове, започващи с "d"
		- Търсене по тип на файл
		
			`find / -type f` - търси файлове
			`find / -type d` - търси директории

		- Търсене по права за достъп 
		
			`find / -perm 777` - търси всички файлове, които да достъпни за четене, писане и изпълнение за тек. потребител, група и всички останали 

			Правата за достъп могат да бъдат изписани в осмична бр. система или чрез символи:
