...
**За по-четлив и прост запис вместо командата test може да се използват квадратните скоби ([ ]).** Приемете, че "[" е "друго име" на командата тест, затова, когато пишете проверка трябва да има място пред и зад [. Затварящата квадратна скоба играе роля на финален аргумент за "[". 
